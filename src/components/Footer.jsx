  ...
  return (
    <footer style={{ background: '#060e1a', borderTop: '1px solid rgba(201,151,58,0.15)', padding: '5rem 2rem 2rem' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <img src={logoImg} alt="Charles" style={{ width: 40, height: 40 }} />
            <div>
              <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 22, fontWeight: 300, letterSpacing: '0.18em', background: 'linear-gradient(135deg, #c9973a, #f5e0a8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Charles</div>
      ...
      <div style={{ borderTop: '1px solid rgba(201,151,58,0.1)', marginTop: 40, paddingTop: 20, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
        <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: 11 }}>© 2026 Charles. All rights reserved.</p>
      </div>
    </footer>
  );
}
